...
local en = {
				...
				cancel = "Cancel",
				yes = "Yes",
				add_more_jewels = "ADD MORE DOTS",
				you_have = "You have",
				desc1 = "5 Extra movements",
				desc2 = "Removes 1 dot",
				desc3 = "Diagonals are allowed",
				not_enough_jewels = "Not Enough Dots!",
...
local es = {
				...
				one_dagger = "DIAGONAL A LA VISTA",
